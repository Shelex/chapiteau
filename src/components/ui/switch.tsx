...
interface CustomProps {
    checkeditem?: React.ReactNode;
    uncheckeditem?: React.ReactNode;
}

const Switch = React.forwardRef<
    React.ElementRef<typeof SwitchPrimitives.Root>,
    React.ComponentPropsWithoutRef<typeof SwitchPrimitives.Root> & CustomProps
>(({ className, ...props }, ref) => (
    <SwitchPrimitives.Root
        ...
        ref={ref}
    >
        {props.checked && props?.checkeditem}
        ...
        />
        {!props.checked && props?.uncheckeditem}
    </SwitchPrimitives.Root>
));
